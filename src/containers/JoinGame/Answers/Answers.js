  ...
  return (
    <Row className={[styles.CenterContents, styles.MainRow]}>
      ...
      {props.values.questionType === 'img' ? (
        <Col xs={12} md={12}>
          <img src={props.values.image} alt="appended picture of question" />{' '}
        </Col>
      ) : null}
        ...
        <Aux>
          <Col xs={12} md={6}>
            <AnswerButton
              ...
              clicked={() => (answer = props.values.answers.answerOne)}
            >
          ...
          <Col xs={12} md={6}>
            <AnswerButton
              disabled={props.disabled}
              clicked={() => (answer = props.values.answers.answerTwo)}
            >
          ...
          <Col xs={12} md={6}>
            <AnswerButton
              disabled={props.disabled}
              clicked={() => (answer = props.values.answers.answerThree)}
            >
      ...
      <Col xs={12} md={12}>
        ...
        <Button
          disabled={props.disabled}
          onClick={() => props.addAnswerHandler(answer)}
        >
          Next Question
        </Button>
      </Col>
